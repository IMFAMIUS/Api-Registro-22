...
public class CategoriaController {
    ...
    @PostMapping
    public Categoria add(@RequestBody Categoria ca){
        return categoriaService.add(ca);
    }  
    
    @PutMapping("/{id}")
    public Categoria update(@PathVariable Long id,@RequestBody Categoria ca){
        ca.setCodigo(id);
        return categoriaService.update(ca);
    }  
    @DeleteMapping("/{id}")
